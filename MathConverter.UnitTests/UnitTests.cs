...
namespace HexInnovation
{
    static class MyAssert
    {
        ...
        public static void AreEqual(double expected, double actual, double delta) =>
            NUnitAssert.AreEqual(expected, actual, delta);
    }
...
#pragma warning disable CS0464 // Comparing with null of type 'double?' always produces 'false'
    ...
    public class MathConverterTests
    {
        ...
        public void TestUnaryPlusAndMinus()
        {
            ...
            Assert.AreEqual(+4 * (+x + +x),
                _converter.Convert(args, typeof(object), "+4(+x+ +x)", new CultureInfo("de")));
            ...
            Assert.AreEqual(+4 * Math.Pow(x, 3),
                _converter.Convert(args, typeof(object), "+4x3", new CultureInfo("de")));
            try
            {
        ...
        {
            Assert.AreEqual(new CornerRadius(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(CornerRadius), null, new CultureInfo("de")));
            Assert.AreEqual(new CornerRadius(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(CornerRadius), "x,y,z,[3]",
                    new CultureInfo("de")));
            Assert.AreEqual(new CornerRadius(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(CornerRadius), "1,2,3,4",
                    new CultureInfo("de")));
            Assert.AreEqual(new CornerRadius(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(CornerRadius), "`1,2,3,4`",
                    new CultureInfo("de")));
            ...
            Assert.AreEqual(new GridLength(1, pixel),
                _converter.Convert(new object[] { 1 }, typeof(GridLength), "x", new CultureInfo("de")));
            Assert.AreEqual(new GridLength(1, pixel),
                _converter.Convert(new object[] { 1 }, typeof(GridLength), null, new CultureInfo("de")));
            Assert.AreEqual(new GridLength(1, GridUnitType.Star),
                _converter.Convert(new object[] { 1 }, typeof(GridLength), "$`{x}*`", new CultureInfo("de")));
            Assert.AreEqual(new GridLength(1, GridUnitType.Star),
                _converter.Convert(new object[0], typeof(GridLength), "`1*`", new CultureInfo("de")));

            Assert.AreEqual(new Thickness(1),
                _converter.Convert(new object[] { 1 }, typeof(Thickness), "x", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1),
                _converter.Convert(new object[] { 1 }, typeof(Thickness), "1", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1),
                _converter.Convert(new object[] { 1 }, typeof(Thickness), null, new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Thickness), "x;y;x;y", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Thickness), "x,y,x,y", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Thickness), "x,y;x,y", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Thickness), "x;y", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Thickness), "x,y", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Thickness), "1;2;1;2", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Thickness), "1,2,1,2", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Thickness), "1,2;1,2", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Thickness), "1;2", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Thickness), "1,2", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Thickness), null, new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(Thickness), "x;y;z;[3]", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(Thickness), "x,y,z,[3]", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(Thickness), "x,y;z,4", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(Thickness), "1;2;3;4", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(Thickness), "1,2,3,4", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(Thickness), "1,2;3,4", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(Thickness), null, new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 1, 2),
                _converter.Convert(new object[0], typeof(Thickness), "`1,2,1,2`", new CultureInfo("de")));
            Assert.AreEqual(new Thickness(1, 2, 1, 2),
                _converter.Convert(new object[0], typeof(Thickness), "`1,2`", new CultureInfo("de")));

            Assert.AreEqual(new Rect(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(Rect), "x;y;z;[3]", new CultureInfo("de")));
            Assert.AreEqual(new Rect(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(Rect), "x,y,z,[3]", new CultureInfo("de")));
            Assert.AreEqual(new Rect(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(Rect), "x,y;z,4", new CultureInfo("de")));
            Assert.AreEqual(new Rect(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(Rect), "1;2;3;4", new CultureInfo("de")));
            Assert.AreEqual(new Rect(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(Rect), "1,2,3,4", new CultureInfo("de")));
            Assert.AreEqual(new Rect(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(Rect), "1,2;3,4", new CultureInfo("de")));
            Assert.AreEqual(new Rect(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(Rect), null, new CultureInfo("de")));
            Assert.AreEqual(new Rect(1, 2, 3, 4),
                _converter.Convert(new object[] { 1, 2, 3, 4 }, typeof(Rect), "`1,2,3,4`", new CultureInfo("de")));

            Assert.AreEqual(new Size(1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Size), "x;y", new CultureInfo("de")));
            Assert.AreEqual(new Size(1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Size), "x,y", new CultureInfo("de")));
            Assert.AreEqual(new Size(1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Size), "1;2", new CultureInfo("de")));
            Assert.AreEqual(new Size(1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Size), "1,2", new CultureInfo("de")));
            Assert.AreEqual(new Size(1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Size), null, new CultureInfo("de")));
            Assert.AreEqual(new Size(1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Size), "`1,2`", new CultureInfo("de")));

            Assert.AreEqual(new Point(1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Point), "x;y", new CultureInfo("de")));
            Assert.AreEqual(new Point(1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Point), "x,y", new CultureInfo("de")));
            Assert.AreEqual(new Point(1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Point), "1;2", new CultureInfo("de")));
            Assert.AreEqual(new Point(1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Point), "1,2", new CultureInfo("de")));
            Assert.AreEqual(new Point(1, 2),
                _converter.Convert(new object[] { 1, 2 }, typeof(Point), null, new CultureInfo("de")));
            ...
            Assert.AreEqual(Geometry.Parse("M 0,0 L 100,100 L 100,0 Z").ToString(),
                _converter.Convert(new object[0], typeof(Geometry), "`M 0,0 L 100,100 L 100,0 Z`",
                    new CultureInfo("de")).ToString());
        }
        ...
        public void TestCache()
        {
            ...
            {
                Assert.IsTrue(ReferenceEquals(_converter.ParseParameter(converterParameter),
                    _converter.ParseParameter(converterParameter)));
                Assert.IsFalse(ReferenceEquals(_converterNoCache.ParseParameter(converterParameter),
                    _converterNoCache.ParseParameter(converterParameter)));
            }
        }
        ...
        public void TestConstantNumbers()
        {
            foreach (var culture in new CultureInfo[] { CultureInfo.InvariantCulture, new CultureInfo("de") })
            {
                ...
                foreach (var @type in new Type[]
                         {
                             typeof(float), typeof(int), typeof(double), typeof(long), typeof(decimal), typeof(byte),
                             typeof(sbyte), typeof(char), typeof(short), typeof(ushort), typeof(uint), typeof(ulong)
                         })
                {
        ...
        public void TestVariables()
        {
            foreach (var culture in new CultureInfo[] { CultureInfo.InvariantCulture, new CultureInfo("de") })
            {
                ...
                Assert.AreEqual(0,
                    (int)_converter.Convert(new object[] { 0, 1, 2, 3, 4, 5, 6 }, typeof(int), "x", culture));
                Assert.AreEqual(0,
                    (int)_converter.Convert(new object[] { 0, 1, 2, 3, 4, 5, 6 }, typeof(int), "[0]", culture));
                Assert.AreEqual(1,
                    (int)_converter.Convert(new object[] { 0, 1, 2, 3, 4, 5, 6 }, typeof(int), "y", culture));
                Assert.AreEqual(1,
                    (int)_converter.Convert(new object[] { 0, 1, 2, 3, 4, 5, 6 }, typeof(int), "[1]", culture));
                Assert.AreEqual(2,
                    (int)_converter.Convert(new object[] { 0, 1, 2, 3, 4, 5, 6 }, typeof(int), "z", culture));
                Assert.AreEqual(2,
                    (int)_converter.Convert(new object[] { 0, 1, 2, 3, 4, 5, 6 }, typeof(int), "[2]", culture));
                Assert.AreEqual(3,
                    (int)_converter.Convert(new object[] { 0, 1, 2, 3, 4, 5, 6 }, typeof(int), "[3]", culture));
                Assert.AreEqual(4,
                    (int)_converter.Convert(new object[] { 0, 1, 2, 3, 4, 5, 6 }, typeof(int), "[4]", culture));
                Assert.AreEqual(5,
                    (int)_converter.Convert(new object[] { 0, 1, 2, 3, 4, 5, 6 }, typeof(int), "[5]", culture));
                Assert.AreEqual(6,
                    (int)_converter.Convert(new object[] { 0, 1, 2, 3, 4, 5, 6 }, typeof(int), "[6]", culture));

                try
                {
                    var invalid = (int)_converter.Convert(new object[] { 0, 1, 2, 3, 4, 5, 6 }, typeof(int), "[7]",
                        culture);
        ...
        public void TestStrings()
        {
            foreach (var culture in new CultureInfo[] { CultureInfo.InvariantCulture, new CultureInfo("de") })
            {
                Assert.AreEqual("Hello",
                    (string)_converter.Convert(new object[] { 3 }, typeof(string), @"""Hello""", culture));
                Assert.AreEqual("Hello",
                    (string)_converter.Convert(new object[] { 3 }, typeof(string), @"`Hello`", culture));
                Assert.AreEqual("Hello",
                    (string)_converter.Convert(new object[] { 3 }, typeof(string), @"'Hello'", culture));
                Assert.AreEqual("H\"e'l\"l`o",
                    (string)_converter.Convert(new object[] { 3 }, typeof(string), @"`H\""e'l""l\`o`", culture));
                Assert.AreEqual("Hel`lo",
                    (string)_converter.Convert(new object[] { 3 }, typeof(string), @"`Hel\`lo`", culture));
                Assert.AreEqual("He`l'l\"o\t",
                    (string)_converter.Convert(new object[] { 3 }, typeof(string), @"""He`l'l\""o\t""", culture));
                Assert.AreEqual("\a\b\f\n\r\t\v\\`\"'",
                    (string)_converter.Convert(new object[] { 3 }, typeof(string), @"""\a\b\f\n\r\t\v\\\`\""'""",
                        culture));
        ...
        public void TestExponents()
        {
            ...
            Assert.AreEqual(Math.Pow(x, 3),
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "x^3", new CultureInfo("de")));
            Assert.AreEqual(Math.Pow(y, 3),
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "y^3", new CultureInfo("de")));
            Assert.AreEqual(Math.Pow(y, x),
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "y^x", new CultureInfo("de")));
            Assert.AreEqual(Math.Pow(y, x / 3),
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "y^(x/3)", new CultureInfo("de")));
            Assert.AreEqual(Math.Pow(y, 2),
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "y2", new CultureInfo("de")));
            Assert.AreEqual(Math.Pow(y, 2),
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "y^2", new CultureInfo("de")));
            Assert.AreEqual(Math.Pow(x, 2),
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "x2", new CultureInfo("de")));
            Assert.AreEqual(Math.Pow(x, 2),
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "x^2", new CultureInfo("de")));
        }
        ...
        public void TestMultiplicative()
        {
            ...
            Assert.AreEqual(4 * x * 3 * y,
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "4x*3y", new CultureInfo("de")));
            Assert.AreEqual(x * x * y,
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "xxy", new CultureInfo("de")));
            Assert.AreEqual(x * x * y,
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "x*xy", new CultureInfo("de")));
            Assert.AreEqual(x * x * y,
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "xx*y", new CultureInfo("de")));
            Assert.AreEqual(x * x * y,
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "x*x*y", new CultureInfo("de")));

            Assert.AreEqual(x * 2 * y,
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "x(2)[1]", new CultureInfo("de")));
            Assert.AreEqual(x * x * y,
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "[0]x[1]", new CultureInfo("de")));
            Assert.AreEqual(x * x * y,
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "x*[0][1]", new CultureInfo("de")));
            Assert.AreEqual(x * x * y,
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "[0][0]*[1]", new CultureInfo("de")));
            Assert.AreEqual(x * x * y,
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "x*x*[1]", new CultureInfo("de")));

            Assert.AreEqual(x * 2 * y * 2,
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "x(2)*y(2)", new CultureInfo("de")));
            Assert.AreEqual(x * x * y * y,
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "xx*yy", new CultureInfo("de")));
            Assert.AreEqual(x * x * x % y,
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "xxx%y", new CultureInfo("de")));
            Assert.AreEqual(x * x * x % y * x,
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "xxx%yx", new CultureInfo("de")));
            Assert.AreEqual(x % y,
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "x%y", new CultureInfo("de")));
            Assert.AreEqual(y % x,
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "y%x", new CultureInfo("de")));
            Assert.AreEqual(y / x,
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "y/x", new CultureInfo("de")));
            Assert.AreEqual(y / y * x % y,
                (double)_converter.Convert(new object[] { x, y }, typeof(double), "y/yx%y", new CultureInfo("de")));
        }
        ...
        public void TestRelational()
        {
            ...
            Assert.AreEqual(x < x,
                (bool)_converter.Convert(new object[] { x, y }, typeof(bool), "x<x", new CultureInfo("de")));
            Assert.AreEqual(x <= x,
                (bool)_converter.Convert(new object[] { x, y }, typeof(bool), "x<=x", new CultureInfo("de")));
            Assert.AreEqual(x > x,
                (bool)_converter.Convert(new object[] { x, y }, typeof(bool), "x>x", new CultureInfo("de")));
            Assert.AreEqual(x >= x,
                (bool)_converter.Convert(new object[] { x, y }, typeof(bool), "x>=x", new CultureInfo("de")));
            Assert.AreEqual(x < y,
                (bool)_converter.Convert(new object[] { x, y }, typeof(bool), "x<y", new CultureInfo("de")));
            Assert.AreEqual(x <= y,
                (bool)_converter.Convert(new object[] { x, y }, typeof(bool), "x<=y", new CultureInfo("de")));
            Assert.AreEqual(x > y,
                (bool)_converter.Convert(new object[] { x, y }, typeof(bool), "x>y", new CultureInfo("de")));
            Assert.AreEqual(x >= y,
                (bool)_converter.Convert(new object[] { x, y }, typeof(bool), "x>=y", new CultureInfo("de")));
            Assert.AreEqual(y < y,
                (bool)_converter.Convert(new object[] { x, y }, typeof(bool), "y<y", new CultureInfo("de")));
            Assert.AreEqual(y <= y,
                (bool)_converter.Convert(new object[] { x, y }, typeof(bool), "y<=y", new CultureInfo("de")));
            Assert.AreEqual(y > y,
                (bool)_converter.Convert(new object[] { x, y }, typeof(bool), "y>y", new CultureInfo("de")));
        ...
        public void TestNullCoalescing()
        {
            ...
            Assert.AreEqual(x ?? x,
                (int?)_converter.Convert(new object[] { x, y }, typeof(int?), "x??x", new CultureInfo("de")));
            Assert.AreEqual(x ?? y,
                (int?)_converter.Convert(new object[] { x, y }, typeof(int?), "x??y", new CultureInfo("de")));
            Assert.AreEqual(y,
                (int?)_converter.Convert(new object[] { x, y }, typeof(int?), "y??x", new CultureInfo("de")));
            Assert.AreEqual(y,
                (int?)_converter.Convert(new object[] { x, y }, typeof(int?), "y??y", new CultureInfo("de")));
            Assert.AreEqual(4,
                (int?)_converter.Convert(new object[] { x, y }, typeof(int?), "null??4", new CultureInfo("de")));
        }
        ...
        public void TestTernary()
        {
            ...
            Assert.AreEqual(true ? true ? 1.0 : 0 : 0,
                _converter.Convert(new object[0], typeof(object), "true ? true?1:0 : 0", new CultureInfo("de")));
            Assert.AreEqual(true ? x : y,
                (int?)_converter.Convert(new object[] { x, y }, typeof(int?), "true ? x : y", new CultureInfo("de")));
            Assert.AreEqual(false ? x : y,
                (int?)_converter.Convert(new object[] { x, y }, typeof(int?), "false ? x : y", new CultureInfo("de")));
            Assert.AreEqual(true ? y : x,
                (int?)_converter.Convert(new object[] { x, y }, typeof(int?), "true ? y : x", new CultureInfo("de")));
            Assert.AreEqual(false ? y : x,
                (int?)_converter.Convert(new object[] { x, y }, typeof(int?), "false ? y : x", new CultureInfo("de")));

            try
            {
                // UnsetValue is not yet available in Xamarin.Forms
                _converter.Convert(new object[] { DependencyProperty.UnsetValue }, typeof(int?), "x ? true : false",
                    new CultureInfo("de"));

                var dependencyPropertyClass = nameof(DependencyProperty);

                Assert.Fail(
                    $"This should have thrown an exception. We should evaluate {dependencyPropertyClass}.{nameof(DependencyProperty.UnsetValue)} as null, which fails as the first operand of the Ternary operator.");
            }
            catch (EvaluationException ex) when (ex.Message ==
                                                 $"MathConverter threw an exception while performing a conversion.{Environment.NewLine}{Environment.NewLine}ConverterParameter:{Environment.NewLine}x ? true : false{Environment.NewLine}{Environment.NewLine}BindingValues:{Environment.NewLine}[0]: ({DependencyProperty.UnsetValue.GetType().FullName}):  {DependencyProperty.UnsetValue}" &&
                                                 ex.InnerException.Message ==
                                                 $"A System.InvalidOperationException was thrown while evaluating the TernaryNode:{Environment.NewLine}(x ? True : False)" &&
        ...
        {
            var geometry = _converter.Convert(new object[] { 100 }, typeof(Geometry), "$`M{x},{x}L{2x},{2x}`",
            ...
            Assert.IsInstanceOfType(
                _converter.Convert(new object[] { 100 }, typeof(Geometry),
                    "$`M {0.1x},{x} C {x/10},{3x} {3x},-{4x/2} {3*x},{x}`", CultureInfo.InvariantCulture),
                typeof(Geometry));
        }
        ...
        {
            {
                ...
                // ?? applied before ?:
                Assert.AreEqual(x.Value ? y ?? x : z ?? (object)3.0,
                    _converter.Convert(args, typeof(object), "x ? y ?? x : z ?? 3.0", new CultureInfo("de")));
                Assert.AreEqual(y.Value ? y ?? x : z ?? (object)3.0,
                    _converter.Convert(args, typeof(object), "y ? y ?? x : z ?? 3.0", new CultureInfo("de")));
                Assert.AreEqual(y ?? x.Value ? true : false,
                    _converter.Convert(args, typeof(object), "y ?? x ? true : false", new CultureInfo("de")));
                // || applied before ?:
                Assert.AreEqual(x.Value || y.Value ? 1.0 : 0.0,
                    _converter.Convert(args, typeof(object), "x || y ? 1.0 : 0.0", new CultureInfo("de")));
                // && applied before ?:
                Assert.AreEqual(y.Value && x.Value ? 1.0 : 0.0,
                    _converter.Convert(args, typeof(object), "y && x ? 1.0 : 0.0", new CultureInfo("de")));
                // ==,!= applied before ?:
                Assert.AreEqual(x != y ? 1.0 : 0.0,
                    _converter.Convert(args, typeof(object), "x != y ? 1.0 : 0.0", new CultureInfo("de")));
                Assert.AreEqual(y == y ? 1.0 : 0.0,
                    _converter.Convert(args, typeof(object), "y == y ? 1.0 : 0.0", new CultureInfo("de")));
                // <,<=,>,>= applied before ?:
                Assert.AreEqual(1 < 2 ? (object)0.0 : 0 > 1,
                    _converter.Convert(args, typeof(object), "1 < 2 ? 0.0 : 0 > 1", new CultureInfo("de")));
                Assert.AreEqual(1 > 2 ? (object)0.0 : 0 > 1,
                    _converter.Convert(args, typeof(object), "1 > 2 ? 0.0 : 0 > 1", new CultureInfo("de")));
                Assert.AreEqual(1 <= 2 ? (object)0.0 : 0 > 1,
                    _converter.Convert(args, typeof(object), "1 <= 2 ? 0.0 : 0 > 1", new CultureInfo("de")));
                Assert.AreEqual(1 >= 2 ? (object)0.0 : 0 > 1,
                    _converter.Convert(args, typeof(object), "1 >= 2 ? 0.0 : 0 > 1", new CultureInfo("de")));
                // +,- applied before ?:
                Assert.AreEqual(true ? 0.0 : 0.0 + 4,
                    _converter.Convert(args, typeof(object), "true ? 0.0 : 0.0 + 4", new CultureInfo("de")));
                Assert.AreEqual(true ? 0.0 : 0.0 - 4,
                    _converter.Convert(args, typeof(object), "true ? 0.0 : 0.0 - 4", new CultureInfo("de")));
                // *,/ applied before ?:
                Assert.AreEqual(true ? 1.0 : 1 * 4.0,
                    _converter.Convert(args, typeof(object), "true ? 1.0 : 1 * 4.0", new CultureInfo("de")));
                Assert.AreEqual(true ? 1.0 : 1 / 4.0,
                    _converter.Convert(args, typeof(object), "true ? 1.0 : 1 / 4.0", new CultureInfo("de")));

                // || applied before ??
                Assert.AreEqual(z ?? y | z ?? x,
                    _converter.Convert(args, typeof(object), "z ?? y || z ?? x", new CultureInfo("de")));
                // && applied before ?? Assert.AreEqual(z ?? x & z ?? x,
                Assert.AreEqual(z ?? x & z ?? x,
                    _converter.Convert(args, typeof(object), "z ?? x && z ?? x", new CultureInfo("de")));
                // ==,!= applied before ??
                Assert.AreEqual(z ?? (bool?)(x == z) ?? x,
                    _converter.Convert(args, typeof(object), "z ?? x == z ?? x", new CultureInfo("de")));
                Assert.AreEqual(z ?? (bool?)(x != z) ?? x,
                    _converter.Convert(args, typeof(object), "z ?? x != z ?? x", new CultureInfo("de")));
                // <,<=,>,>= applied before ??
                Assert.AreEqual((bool?)(1 > (int?)(object)z) ?? (object)4,
                    _converter.Convert(args, typeof(object), "1 > z ?? 4", new CultureInfo("de")));
                Assert.AreEqual((bool?)(1 < (int?)(object)z) ?? (object)4,
                    _converter.Convert(args, typeof(object), "1 < z ?? 4", new CultureInfo("de")));
                Assert.AreEqual((bool?)(1 >= (int?)(object)z) ?? (object)4,
                    _converter.Convert(args, typeof(object), "1 >= z ?? 4", new CultureInfo("de")));
                Assert.AreEqual((bool?)(1 <= (int?)(object)z) ?? (object)4,
                    _converter.Convert(args, typeof(object), "1 <= z ?? 4", new CultureInfo("de")));
                // +,- applied before ??
                Assert.AreEqual(1 + (int?)(object)z ?? 2.0,
                    _converter.Convert(args, typeof(object), "1 + z ?? 2.0", new CultureInfo("de")));
                Assert.AreEqual(1 - (int?)(object)z ?? 2.0,
                    _converter.Convert(args, typeof(object), "1 - z ?? 2.0", new CultureInfo("de")));
                // *,/ applied before ??
                Assert.AreEqual(2 * (int?)(object)z ?? 4.0,
                    _converter.Convert(args, typeof(object), "2 * z ?? 4.0", new CultureInfo("de")));
                Assert.AreEqual(2 / (int?)(object)z ?? 4.0,
                    _converter.Convert(args, typeof(object), "2 / z ?? 4.0", new CultureInfo("de")));


                // && applied before ||
                Assert.AreEqual(x.Value && y.Value || x.Value,
                    _converter.Convert(args, typeof(object), "x && y || x", new CultureInfo("de")));
                Assert.AreEqual(x.Value || y.Value && x.Value,
                    _converter.Convert(args, typeof(object), "x || y && x", new CultureInfo("de")));
                // ==,!= applied before ||
                Assert.AreEqual(z == z || y.Value,
                    _converter.Convert(args, typeof(object), "z == z || y", new CultureInfo("de")));
                Assert.AreEqual(3 != (int?)(object)z || y.Value,
                    _converter.Convert(args, typeof(object), "3 != z || y", new CultureInfo("de")));
                // <,<=,>,>= applied before ||
                Assert.AreEqual(1 > 2 || y.Value,
                    _converter.Convert(args, typeof(object), "1 > 2 || y", new CultureInfo("de")));
                Assert.AreEqual(1 < 2 || y.Value,
                    _converter.Convert(args, typeof(object), "1 < 2 || y", new CultureInfo("de")));
                Assert.AreEqual(1 >= 2 || y.Value,
                    _converter.Convert(args, typeof(object), "1 >= 2 || y", new CultureInfo("de")));
                ...
                try
                {
                    _converter.Convert(args, typeof(object), "y || y + \"a\"", new CultureInfo("de"));
                    Assert.Fail("|| is applied before +");
                }
                catch (Exception ex) when (ex.InnerException.InnerException.Message ==
                                           "Cannot apply operator '||' to operands of type 'System.Boolean' and 'System.String'")
                {
                }

                try
                {
                    _converter.Convert(args, typeof(object), "y - 3 || y", new CultureInfo("de"));
                    Assert.Fail("|| is applied before -");
                }
                catch (Exception ex) when (ex.InnerException.InnerException.Message ==
                                           "Cannot apply operator '-' to operands of type 'System.Boolean' and 'System.Double'")
                {
                }
                ...
                // ==,!= applied before &&
                Assert.AreEqual(z == z && x.Value,
                    _converter.Convert(args, typeof(object), "z == z && x", new CultureInfo("de")));
                Assert.AreEqual(z != z && x.Value,
                    _converter.Convert(args, typeof(object), "z != z && x", new CultureInfo("de")));
                // <,<=,>,>= applied before &&
                Assert.AreEqual(1 > 2 && y.Value,
                ...
                try
                {
                    _converter.Convert(args, typeof(object), "x && x + \"a\"", new CultureInfo("de"));
                    Assert.Fail("&& is applied before +");
                }
                catch (Exception ex) when (ex.InnerException.InnerException.Message ==
                                           "Cannot apply operator '&&' to operands of type 'System.Boolean' and 'System.String'")
                ...
                try
                {
                    _converter.Convert(args, typeof(object), "x - 3 && x", new CultureInfo("de"));
                    Assert.Fail("&& is applied before -");
                }
                catch (Exception ex) when (ex.InnerException.InnerException.Message ==
                                           "Cannot apply operator '-' to operands of type 'System.Boolean' and 'System.Double'")
                ...
                Assert.AreEqual(1 < 2 == true,
                    _converter.Convert(args, typeof(object), "1 < 2 == true", new CultureInfo("de")));
                Assert.AreEqual(1 < 2 != false,
                    _converter.Convert(args, typeof(object), "1 < 2 != false", new CultureInfo("de")));
                Assert.AreEqual(1 <= 2 == true,
                    _converter.Convert(args, typeof(object), "1 <= 2 == true", new CultureInfo("de")));
                Assert.AreEqual(1 <= 2 != false,
                    _converter.Convert(args, typeof(object), "1 <= 2 != false", new CultureInfo("de")));
                ...
                Assert.AreEqual(1 + 1 == 2,
                    _converter.Convert(args, typeof(object), "1 + 1 == 2", new CultureInfo("de")));
                Assert.AreEqual(1 + 1 != 2,
                    _converter.Convert(args, typeof(object), "1 + 1 != 2", new CultureInfo("de")));
                Assert.AreEqual(1 - 1 == 0,
                    _converter.Convert(args, typeof(object), "1 - 1 == 0", new CultureInfo("de")));
                Assert.AreEqual(1 - 1 != 0,
                    _converter.Convert(args, typeof(object), "1 - 1 != 0", new CultureInfo("de")));
                // *,/ applied before ==,!=
                Assert.AreEqual(3.0 * 1 == 3.0,
                    _converter.Convert(args, typeof(object), "3.0 * 1 == 3.0", new CultureInfo("de")));
                Assert.AreEqual(3.0 * 1 != 3.0,
                    _converter.Convert(args, typeof(object), "3.0 * 1 != 3.0", new CultureInfo("de")));
                Assert.AreEqual(3.0 / 1 == 3.0,
                    _converter.Convert(args, typeof(object), "3.0 / 1 == 3.0", new CultureInfo("de")));
                ...
                Assert.AreEqual(3 * 1 > 3,
                    _converter.Convert(args, typeof(object), "3 * 1 > 3", new CultureInfo("de")));
                Assert.AreEqual(3 * 1 < 3,
                    _converter.Convert(args, typeof(object), "3 * 1 < 3", new CultureInfo("de")));
                Assert.AreEqual(3 / 1 < 3,
                    _converter.Convert(args, typeof(object), "3 / 1 < 3", new CultureInfo("de")));
                ...
                Assert.AreEqual(1 + 2.0 * 2,
                    _converter.Convert(args, typeof(object), "1 + 2.0 * 2", new CultureInfo("de")));
                Assert.AreEqual(1 + 2.0 / 2,
                    _converter.Convert(args, typeof(object), "1 + 2.0 / 2", new CultureInfo("de")));
                Assert.AreEqual(2 * 2.0 - 1,
                    _converter.Convert(args, typeof(object), "2 * 2.0 - 1", new CultureInfo("de")));
                Assert.AreEqual(2 / 2.0 - 1,
                    _converter.Convert(args, typeof(object), "2 / 2.0 - 1", new CultureInfo("de")));
            }

            {
                ...
                object[] args = { x, y, z };
                // ^ applied before ?:
                Assert.AreEqual(true ? 0.0 : x2,
                    _converter.Convert(args, typeof(object), "true ? 0.0 : x2", new CultureInfo("de")));
                Assert.AreEqual(true ? 0.0 : x2,
                    _converter.Convert(args, typeof(object), "true ? 0.0 : x^2", new CultureInfo("de")));
                // ^ applied before ??
                Assert.AreEqual(null ?? (double?)x2,
                    _converter.Convert(args, typeof(object), "null??x2", new CultureInfo("de")));
                Assert.AreEqual(null ?? (double?)x2,
                    _converter.Convert(args, typeof(object), "null??x^2", new CultureInfo("de")));
                // ^ applied before ||
                ...
                try
                {
                    _converter.Convert(args, typeof(object), "x ^ true && true ? x : 0", new CultureInfo("de"));
                    Assert.Fail("3 ^ true should return null, which cannot be AND-ed");
                }
                catch (Exception ex) when (ex.InnerException.InnerException.Message ==
                                           "Cannot apply operator '^' to operands of type 'System.Double' and 'System.Boolean'")
                {
                }

                Assert.AreEqual(Math.Pow(x, true && true ? x : 0),
                    _converter.Convert(args, typeof(object), "x ^ (true && true ? x : 0)", new CultureInfo("de")));
                // ^ applied before ==,!=
                ...
                Assert.AreEqual(!true || true,
                    _converter.Convert(args, typeof(object), "!true||true", new CultureInfo("de")));
                Assert.AreEqual(!(true || true),
                    _converter.Convert(args, typeof(object), "!(true||true)", new CultureInfo("de")));
                // parentheses before -
                Assert.AreEqual(-3.0 - 3, _converter.Convert(args, typeof(object), "-3.0-3", new CultureInfo("de")));
                Assert.AreEqual(-(3.0 - 3),
                    _converter.Convert(args, typeof(object), "-(3.0-3)", new CultureInfo("de")));
                // parentheses before ^
                Assert.AreEqual(Math.Pow(x * y, x * y),
                    _converter.Convert(args, typeof(object), "(xy)^(xy)", new CultureInfo("de")));
                Assert.AreEqual(Math.Pow(x * y, x) * y,
                    _converter.Convert(args, typeof(object), "(xy)^xy", new CultureInfo("de")));
                Assert.AreEqual(x * Math.Pow(y, x) * y,
                    _converter.Convert(args, typeof(object), "xy^xy", new CultureInfo("de")));
                Assert.AreEqual(x * Math.Pow(y, x * y),
                    _converter.Convert(args, typeof(object), "xy^(xy)", new CultureInfo("de")));
                // parentheses before *,/
                ...
                Assert.AreEqual(x / (y * x), _converter.Convert(args, typeof(object), "x/(yx)", new CultureInfo("de")));
                // parentheses before +,-
                Assert.AreEqual(1.0 - 2 + 1,
                    _converter.Convert(args, typeof(object), "1.0-2+1", new CultureInfo("de")));
                Assert.AreEqual(1.0 - (2 + 1),
                    _converter.Convert(args, typeof(object), "1.0-(2+1)", new CultureInfo("de")));
                Assert.AreEqual(true ? 0.0 : 1 + 1,
                    _converter.Convert(args, typeof(object), "true ? 0.0 : 1 + 1", new CultureInfo("de")));
                Assert.AreEqual((true ? 0.0 : 1) + 1,
                    _converter.Convert(args, typeof(object), "(true ? 0.0 : 1) + 1", new CultureInfo("de")));
                // parentheses before <,<=,>,>=
                Assert.AreEqual(true ? (object)100.0 : 0 < x,
                    _converter.Convert(args, typeof(object), "true ? 100.0 : 0 < x", new CultureInfo("de")));
                Assert.AreEqual(true ? (object)100.0 : 0 > x,
                    _converter.Convert(args, typeof(object), "true ? 100.0 : 0 > x", new CultureInfo("de")));
                Assert.AreEqual(true ? (object)100.0 : 0 <= x,
                    _converter.Convert(args, typeof(object), "true ? 100.0 : 0 <= x", new CultureInfo("de")));
                Assert.AreEqual(true ? (object)100.0 : 0 >= x,
                    _converter.Convert(args, typeof(object), "true ? 100.0 : 0 >= x", new CultureInfo("de")));
                Assert.AreEqual((true ? 100.0 : 0) < x,
                    _converter.Convert(args, typeof(object), "(true ? 100.0 : 0) < x", new CultureInfo("de")));
                Assert.AreEqual((true ? 100.0 : 0) > x,
                    _converter.Convert(args, typeof(object), "(true ? 100.0 : 0) > x", new CultureInfo("de")));
                Assert.AreEqual((true ? 100.0 : 0) <= x,
                ...
                Assert.AreEqual((true ? 100.0 : 0) >= x,
                    _converter.Convert(args, typeof(object), "(true ? 100.0 : 0) >= x", new CultureInfo("de")));
                // parentheses before ==,!=
                Assert.AreEqual(true ? (object)3.0 : 0 == x,
                    _converter.Convert(args, typeof(object), "true ? 3.0 : 0 == x", new CultureInfo("de")));
                Assert.AreEqual(true ? (object)3.0 : 0 != x,
                    _converter.Convert(args, typeof(object), "true ? 3.0 : 0 != x", new CultureInfo("de")));
                Assert.AreEqual((true ? 3.0 : 0) == x,
                    _converter.Convert(args, typeof(object), "(true ? 3.0 : 0) == x", new CultureInfo("de")));
                Assert.AreEqual((true ? 3.0 : 0) != x,
                    _converter.Convert(args, typeof(object), "(true ? 3.0 : 0) != x", new CultureInfo("de")));
                // parentheses before &&
                Assert.AreEqual(true ? (object)true : false && true ? x : 0,
                    _converter.Convert(args, typeof(object), "true ? true : false && true ? x : 0",
                        new CultureInfo("de")));
                Assert.AreEqual((true ? true : false) && true ? x : 0,
                    _converter.Convert(args, typeof(object), "(true ? true : false) && true ? x : 0",
                        new CultureInfo("de")));
                // parentheses before ||
                Assert.AreEqual(true ? false : true || true,
                    _converter.Convert(args, typeof(object), "true ? false : true || true", new CultureInfo("de")));
                Assert.AreEqual((true ? false : true) || true,
                    _converter.Convert(args, typeof(object), "(true ? false : true) || true", new CultureInfo("de")));
                ...
                // parentheses before ??
                Assert.AreEqual(true ? null : (object)z ?? x,
                    _converter.Convert(args, typeof(object), "true ? null : z ?? x", new CultureInfo("de")));
                Assert.AreEqual((true ? null : (object)z) ?? x,
                    _converter.Convert(args, typeof(object), "(true ? null : z) ?? x", new CultureInfo("de")));

                // parentheses before ?:
                Assert.AreEqual(true ? false : true ? false : true,
                    _converter.Convert(args, typeof(object), "true ? false : true ? false : true",
                        new CultureInfo("de")));
                Assert.AreEqual((true ? false : true) ? false : true,
                    _converter.Convert(args, typeof(object), "(true ? false : true) ? false : true",
                        new CultureInfo("de")));
        ...
        public void TestInterpolatedStrings()
        {
            ...
            Assert.AreEqual($"{(true ? x : 0):0}",
                _converter.Convert(args, typeof(object), "$`{(true?x:0):0}`", new CultureInfo("de")));
            Assert.AreEqual($"{(true ? nill : x)}",
                _converter.Convert(args, typeof(object), "$`{(true?null:x)}`", new CultureInfo("de")));
            Assert.AreEqual($"{(true ? x : 0):0}",
                _converter.Convert(args, typeof(object), "$'{(true?x:0):0}'", new CultureInfo("de")));
            Assert.AreEqual($"{(true ? nill : x)}",
                _converter.Convert(args, typeof(object), "$'{(true?null:x)}'", new CultureInfo("de")));
            Assert.AreEqual(string.Format(new CultureInfo("de"), "{0:0.0} + {1:0.0} = {2:0.0}", x, y, x + y),
                _converter.Convert(args, typeof(object), "$`{x:0.0} + {y:0.0} = {x+y:0.0}`", new CultureInfo("de")));

            Assert.AreEqual(
                string.Format(new CultureInfo("de"), "{0:0.0} + {1:0.0} = {2:0.0}", nill ?? x, nill ?? y,
                    nill ?? x + nill ?? y),
                _converter.Convert(args, typeof(object),
                    "$`{null ?? x:0.0} + {null ?? y:0.0} = {null ?? x + null ?? y:0.0}`", new CultureInfo("de")));

            Assert.AreEqual(
                string.Format(new CultureInfo("de"), "{0:`0.0`} + {1:\"0.0\"} = {2:0.0}", nill ?? x, nill ?? y,
                    string.Format(new CultureInfo("de"), "{0}", x + y)),
                _converter.Convert(args, typeof(object),
                    @"$`{null ?? x:\`0.0\`} + {null ?? y:""0.0""} = {$""{x + y}"":0.0}`", new CultureInfo("de")));
            Assert.AreEqual($"a{$"b{$"c{$"{string.Format(new CultureInfo("de"), "{0:0.###}", x)}d"}e"}f"}g",
                _converter.Convert(args, typeof(object), @"$""a{$""b{$""c{$""{x:0.###}d""}e""}f""}g""",
                    new CultureInfo("de")));
            Assert.AreEqual($"a{$"b{$"c{$"{string.Format(new CultureInfo("de"), "{0:0.###}", x)}d"}e"}f"}g",
                _converter.Convert(args, typeof(object), @"$'a{$'b{$'c{$'{x:0.###}d'}e'}f'}g'", new CultureInfo("de")));
            Assert.AreEqual($"a{$"b{$"c{$"{string.Format(new CultureInfo("de"), "{0:0.###}", x)}d"}e"}f"}g",
                _converter.Convert(args, typeof(object), @"$`a{$`b{$`c{$`{x:0.###}d`}e`}f`}g`", new CultureInfo("de")));
            Assert.AreEqual($"a{$"b{$"c{$"{string.Format(new CultureInfo("de"), "{0:0.###}", x)}d"}e"}f"}g",
                _converter.Convert(args, typeof(object), @"$`a{$`b{$`c{$""{x:0.###}d""}e`}f`}g`",
            ...
            Assert.AreEqual($"The speed of light is {speedOfLight.ToString("N3", new CultureInfo("nl-NL"))} km/s.",
                _converter.Convert(args, typeof(object), @"$`The speed of light is {x:N3} km/s.`",
                    new CultureInfo("nl-NL")));
            Assert.AreEqual($"The speed of light is {speedOfLight.ToString("N3", new CultureInfo("en-IN"))} km/s.",
                _converter.Convert(args, typeof(object), @"$`The speed of light is {x:N3} km/s.`",
                    new CultureInfo("en-IN")));
            Assert.AreEqual($"The speed of light is {speedOfLight.ToString("N3", CultureInfo.InvariantCulture)} km/s.",
                _converter.Convert(args, typeof(object), @"$`The speed of light is {x:N3} km/s.`",
                    CultureInfo.InvariantCulture));

            // Make sure commas work in the string format.
            Assert.AreEqual(string.Format(new CultureInfo("de"), "{0, 1: N2}", 30),
                _converter.Convert(args, typeof(object), "$\"{30, 1: N2}\"", new CultureInfo("de")));
            Assert.AreEqual(string.Format(new CultureInfo("de"), "{0,-1: N2}", 30),
                _converter.Convert(args, typeof(object), "$\"{30;-1: N2}\"", new CultureInfo("de")));
            Assert.AreEqual(string.Format(new CultureInfo("de"), "{0, 7: N2}", 30),
                _converter.Convert(args, typeof(object), "$\"{30; 7: N2}\"", new CultureInfo("de")));
            Assert.AreEqual(string.Format(new CultureInfo("de"), "{0,-7: N2}", 30),
                _converter.Convert(args, typeof(object), "$\"{30,-7: N2}\"", new CultureInfo("de")));
            Assert.AreEqual(string.Format(new CultureInfo("de"), "{0, 56: N2}", 30),
                _converter.Convert(args, typeof(object), "$\"{30, 56: N2}\"", new CultureInfo("de")));
        }
        ...
        public void TestFunctions()
        {
            ...
            Assert.AreEqual(0,
                ((DateTime)_converter.Convert(null, typeof(object), "Now()", new CultureInfo("de")) - DateTime.Now)
                .TotalMilliseconds, allowWithinMillis);
            ...
            Assert.AreEqual(3,
                _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "IsNull(x,y)", new CultureInfo("de")));
            Assert.AreEqual(5,
                _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "IsNull(x,z)", new CultureInfo("de")));
            Assert.AreEqual(5,
                _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "IfNull(x,z)", new CultureInfo("de")));
            Assert.AreEqual(3,
                _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "IfNull(y,z)", new CultureInfo("de")));
            Assert.IsNull(_converter.Convert(new object[] { null, 3, 5 }, typeof(object), "IfNull(x,x)",
                new CultureInfo("de")));
            Assert.AreEqual(3,
                _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "IfNull(x,IfNull(x??y,z))",
                    new CultureInfo("de")));
            Assert.AreEqual(3,
                _converter.Convert(new object[] { null, 3, 5 }, typeof(object),
                    "IfNull(y,Throw(`If the first argument is not null, the second should not be evaluated.`))",
                    new CultureInfo("de")));
            Assert.AreEqual(5,
                _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "Max(x;y;x;z)", new CultureInfo("de")));
            Assert.AreEqual(5,
                _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "Max(y;z;z;x;y;y;z)",
                    new CultureInfo("de")));
            Assert.AreEqual(100.0,
                _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "Max(y;z;100)", new CultureInfo("de")));
            Assert.AreEqual(0.0,
                _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "Min(y;z;100;0)",
                    new CultureInfo("de")));
            Assert.AreEqual(3,
                _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "Min(y;z;100)", new CultureInfo("de")));
            Assert.AreEqual(3,
                _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "Min(null,y;z;100)",
                    new CultureInfo("de")));
            Assert.AreEqual(null,
                _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "Min(null,x)", new CultureInfo("de")));
            Assert.AreEqual(4.0,
                _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "Avg(y;z)", new CultureInfo("de")));
            Assert.AreEqual(4.666666666666,
                (double)_converter.Convert(new object[] { null, 3, 5 }, typeof(object), "Avg(y;z;6)",
                    new CultureInfo("de")), 0.00000001);
            Assert.AreEqual(4.0,
                _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "Avg(x;y;z)", new CultureInfo("de")));
            Assert.AreEqual("35",
                _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "Concat(x;y;z)",
                    new CultureInfo("de")));
            Assert.AreEqual("3x5",
                _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "Concat(x;y;\"x\";z)",
                    new CultureInfo("de")));
            Assert.AreEqual(true,
                _converter.Convert(new object[] { "Hello world", "Hello" }, typeof(object),
                    "Contains(\"Hello world\", `Hello`)", new CultureInfo("de")));
            Assert.AreEqual(true,
                _converter.Convert(new object[] { "Hello world", "Hello" }, typeof(object),
                    "Contains(\"Hello world\", y)", new CultureInfo("de")));
            Assert.AreEqual(true,
                _converter.Convert(new object[] { "Hello world", "Hello" }, typeof(object), "Contains(x, `Hello`)",
                    new CultureInfo("de")));
            Assert.AreEqual(true,
                _converter.Convert(new object[] { "Hello world", "Hello" }, typeof(object), "Contains(x, y)",
                    new CultureInfo("de")));
            ...
            Assert.AreEqual(true,
                _converter.Convert(new object[] { new object[] { "hello", "world" } }, typeof(object),
                    "Contains(x, `hello`)", new CultureInfo("de")));
            Assert.AreEqual(false,
                _converter.Convert(new object[] { new object[] { "hello", "world" } }, typeof(object),
                    "Contains(x, `Hello`)", new CultureInfo("de")));

            Assert.AreEqual(true,
                _converter.Convert(new object[] { "ψñíçθдë têsт", "ΨÑÍÇΘДË TÊSТ" }, typeof(object), "ToUpper(x) == y",
                    new CultureInfo("de")));
            Assert.AreEqual(true,
                _converter.Convert(new object[] { "ψñíçθдë têsт", "ΨÑÍÇΘДË TÊSТ" }, typeof(object), "ToLower(y) == x",
                    new CultureInfo("de")));
            Assert.AreEqual(true,
                _converter.Convert(new object[] { "ψñíçθдë têsт", "ΨÑÍÇΘДË TÊSТ" }, typeof(object), "ToUpper(y) == y",
                    new CultureInfo("de")));
            Assert.AreEqual(true,
                _converter.Convert(new object[] { "ψñíçθдë têsт", "ΨÑÍÇΘДË TÊSТ" }, typeof(object), "ToLower(x) == x",
                    new CultureInfo("de")));
            Assert.AreEqual(true,
                _converter.Convert(new object[] { "ψñíçθдë têsт", "ΨÑÍÇΘДË TÊSТ" }, typeof(object),
                    "ToUpper(y) != ToLower(y)", new CultureInfo("de")));
            Assert.AreEqual(true,
                _converter.Convert(new object[] { "ψñíçθдë têsт", "ΨÑÍÇΘДË TÊSТ" }, typeof(object),
                    "ToUpper(x) != ToLower(x)", new CultureInfo("de")));
            var possibleArgs = new object[]
                { new ArithmeticOperatorTester(2), new ArithmeticOperatorTester(0), false, true, null };

            foreach (var x in new bool[] { true, false })
            {
                Assert.AreEqual(x,
                    _converter.Convert(new object[] { x }, typeof(object), "And(And(true,true,true,true,true),x,true)",
                        new CultureInfo("de")));
                Assert.AreEqual(x,
                    _converter.Convert(new object[] { x }, typeof(object),
                        "Or(Or(false,false,false,false,false),x,false)", new CultureInfo("de")));
                Assert.AreEqual(!x,
                    _converter.Convert(new object[] { x }, typeof(object),
                        "Nor(!Nor(false,false,false,false,false),x,false)", new CultureInfo("de")));
                Assert.AreEqual(!x,
                    _converter.Convert(new object[] { x }, typeof(object),
                        "Nor(!Nor(false,false,false,false,false),x,false)", new CultureInfo("de")));
            }
            ...
            for (double x = -5; x < 5; x += 0.1)
            {
                ...
                Assert.AreEqual(Math.Cos(x),
                    (double)_converter.Convert(new object[] { x }, typeof(object), $"Cos(x) / Cos(x) * Cos(x)",
                        new CultureInfo("de")), 0.00000001);
                Assert.AreEqual(Math.Sin(x),
                    (double)_converter.Convert(new object[] { x }, typeof(object), $"Sin(x) / Sin(x) * Sin(x)",
                        new CultureInfo("de")), 0.00000001);
                Assert.AreEqual(Math.Tan(x),
                    (double)_converter.Convert(new object[] { x }, typeof(object), $"Tan(x) / Tan(x) * Tan(x)",
                        new CultureInfo("de")), 0.00000001);
                Assert.AreEqual(Math.Abs(x),
                    (double)_converter.Convert(new object[] { x }, typeof(object), $"Abs(x) / Abs(x) * Abs(x)",
                        new CultureInfo("de")), 0.00000001);
                Assert.AreEqual(Math.Atan(x),
                    (double)_converter.Convert(new object[] { x }, typeof(object), $"Atan(x) / Atan(x) * Atan(x)",
                        new CultureInfo("de")), 0.00000001);
                Assert.AreEqual(Math.Ceiling(x),
                    (double)_converter.Convert(new object[] { x }, typeof(object), $"Ceil(x)", new CultureInfo("de")),
                    0.00000001);
                Assert.AreEqual(Math.Ceiling(x),
                    (double)_converter.Convert(new object[] { x }, typeof(object), $"Ceiling(x)",
                        new CultureInfo("de")), 0.00000001);
                Assert.AreEqual(Math.Floor(x),
                    (double)_converter.Convert(new object[] { x }, typeof(object), $"Floor(x)", new CultureInfo("de")),
                    0.00000001);
                Assert.AreEqual(x / Math.PI * 180,
                    (double)_converter.Convert(new object[] { x }, typeof(object), $"Deg(x) / Degrees(x) * Deg(x)",
                        new CultureInfo("de")), 0.00000001);
                Assert.AreEqual(Math.Round(x),
                    (double)_converter.Convert(new object[] { x }, typeof(object), $"Round(x)", new CultureInfo("de")),
                    0.00000001);
                Assert.AreEqual(Math.Round(x, 1),
                    (double)_converter.Convert(new object[] { x }, typeof(object), $"Round(x,1)",
                        new CultureInfo("de")), 0.00000001);

                if (Math.Abs(x) <= 1)
                {
                    Assert.AreEqual(Math.Acos(x),
                        (double)_converter.Convert(new object[] { x }, typeof(object), $"Acos(x) / Acos(x) * Acos(x)",
                            new CultureInfo("de")), 0.00000001);
                    Assert.AreEqual(Math.Asin(x),
                        (double)_converter.Convert(new object[] { x }, typeof(object), $"Asin(x) / Asin(x) * Asin(x)",
                            new CultureInfo("de")), 0.00000001);
                }

                if (x >= 0)
                {
                    Assert.AreEqual(Math.Sqrt(x),
                        (double)_converter.Convert(new object[] { x }, typeof(object), $"Sqrt(x) / Sqrt(x) * Sqrt(x)",
                            new CultureInfo("de")), 0.00000001);
                }

                for (double y = -5; y < 5; y += 0.1)
                {
                    Assert.AreEqual(Math.Atan2(x, y),
                        (double)_converter.Convert(new object[] { x, y }, typeof(object),
                            $"Atan2(x,y) / ArcTan2(x,y) * Atan2(x;y)", new CultureInfo("de")));
                    Assert.AreEqual(Math.Log(x, y),
                        (double)_converter.Convert(new object[] { x, y }, typeof(object),
                            $"Log(x,y) / Log(x,y) * Log(x;y)", new CultureInfo("de")));
                }
                ...
                foreach (var function in new string[] { "Contains", "StartsWith", "EndsWith" })
                {
                    ...
                    {
                        Assert.IsTrue((bool)_converter.Convert(args, typeof(object), $"{function}(x,y)",
                            new CultureInfo("de")));
                    }
                }
                ...
                Assert.AreEqual(Visibility.Visible,
                    _converter.Convert(new object[] { true }, typeof(object), "VisibleOrHidden(x)",
                        new CultureInfo("de")));
                Assert.AreEqual(Visibility.Visible,
                    _converter.Convert(new object[] { true }, typeof(object), "VisibleOrCollapsed(x)",
                        new CultureInfo("de")));

                foreach (var arg in new object[] { false, null, "true", "false", "Hello World" })
                {
                    Assert.AreEqual(Visibility.Hidden,
                        _converter.Convert(new object[] { arg }, typeof(object), "VisibleOrHidden(x)",
                            new CultureInfo("de")));
                    Assert.AreEqual(Visibility.Collapsed,
                        _converter.Convert(new object[] { arg }, typeof(object), "VisibleOrCollapsed(x)",
                            new CultureInfo("de")));
                }

                Assert.AreEqual(null,
                    _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "TryParseDouble(null)",
                        new CultureInfo("de")));
                Assert.AreEqual(null,
                    _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "TryParseDouble(` `)",
                        new CultureInfo("de")));
                Assert.AreEqual(3.425,
                    _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "TryParseDouble(`3,425`)",
                        new CultureInfo("de")));
                Assert.AreEqual(-3.425,
                    _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "TryParseDouble(`-3,425`)",
                        new CultureInfo("de")));
                Assert.AreEqual(null,
                    _converter.Convert(new object[] { null, 3, 5 }, typeof(object), "TryParseDouble(`INVALID!`)",
                        new CultureInfo("de")));
                Assert.AreEqual(null,
                    _converter.Convert(new object[] { TimeSpan.FromDays(3) }, typeof(object), "TryParseDouble(x)",
                        new CultureInfo("de")));
            }
        }
    }
    ...
    public class OperatorTests
    {
        ...
        public void TestAdditionOperator()
        {
            ...
            Assert.AreEqual((new ArithmeticOperatorTester(1) + new ArithmeticOperatorTester(2)).Value,
                (Operator.Addition.Evaluate(new ArithmeticOperatorTester(1), new ArithmeticOperatorTester(2)) as
                    ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass1(1) + new ArithmeticOperatorTester(2)).Value,
                (Operator.Addition.Evaluate(new ArithmeticOperatorTesterSubClass1(1), new ArithmeticOperatorTester(2))
                    as ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass1(1) + new ArithmeticOperatorTesterSubClass2(2)).Value,
                (Operator.Addition.Evaluate(new ArithmeticOperatorTesterSubClass1(1),
                    new ArithmeticOperatorTesterSubClass2(2)) as ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass2(1) + new ArithmeticOperatorTesterSubClass2(2)).Value,
                (Operator.Addition.Evaluate(new ArithmeticOperatorTesterSubClass2(1),
                    new ArithmeticOperatorTesterSubClass2(2)) as ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass2(1) + new HaveValueClass1(2)).Value,
                (Operator.Addition.Evaluate(new ArithmeticOperatorTesterSubClass2(1), new HaveValueClass1(2)) as
                    ArithmeticOperatorTester).Value);
            ...
            try
            {
                ...
                Assert.Fail(
                    $"Adding a {nameof(ArithmeticOperatorTester)} and a {nameof(ArithmeticOperatorTesterSubClass2)} should throw a {nameof(AmbiguousMatchException)}");
            }
            ...
            try
            {
                ...
                Assert.Fail(
                    $"Adding a {nameof(ArithmeticOperatorTester)} and a {nameof(HaveValueClass2)} should throw a {nameof(AmbiguousMatchException)}");
            }
            catch (AmbiguousMatchException)
            {
            }
            ...
            try
            {
                Operator.Addition.Evaluate(1, new StringBuilder("X"));
                                       ...
                                       "Cannot apply operator '+' to operands of type 'System.Int32' and 'System.Text.StringBuilder'")
            {
            }
            ...
            try
            {
                Operator.Addition.Evaluate(1, true);
                                       ...
                                       "Cannot apply operator '+' to operands of type 'System.Int32' and 'System.Boolean'")
            {
            }
        }
        ...
        public void TestSubtractionOperator()
        {
            ...
            Assert.AreEqual((new ArithmeticOperatorTester(1) - new ArithmeticOperatorTester(2)).Value,
                (Operator.Subtraction.Evaluate(new ArithmeticOperatorTester(1), new ArithmeticOperatorTester(2)) as
                    ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass1(1) - new ArithmeticOperatorTester(2)).Value,
                (Operator.Subtraction.Evaluate(new ArithmeticOperatorTesterSubClass1(1),
                    new ArithmeticOperatorTester(2)) as ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass1(1) - new ArithmeticOperatorTesterSubClass2(2)).Value,
                (Operator.Subtraction.Evaluate(new ArithmeticOperatorTesterSubClass1(1),
                    new ArithmeticOperatorTesterSubClass2(2)) as ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass2(1) - new ArithmeticOperatorTesterSubClass2(2)).Value,
                (Operator.Subtraction.Evaluate(new ArithmeticOperatorTesterSubClass2(1),
                    new ArithmeticOperatorTesterSubClass2(2)) as ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass2(1) - new HaveValueClass1(2)).Value,
                (Operator.Subtraction.Evaluate(new ArithmeticOperatorTesterSubClass2(1), new HaveValueClass1(2)) as
                    ArithmeticOperatorTester).Value);
            ...
            {
                //var thisWillNotCompile = new ArithmeticOperatorTester(1) - new ArithmeticOperatorTesterSubClass2(2);
                Operator.Subtraction.Evaluate(new ArithmeticOperatorTester(1),
                    new ArithmeticOperatorTesterSubClass2(2));
                Assert.Fail(
                    $"Adding a {nameof(ArithmeticOperatorTester)} and a {nameof(ArithmeticOperatorTesterSubClass2)} should throw a {nameof(AmbiguousMatchException)}");
            }
            catch (AmbiguousMatchException)
            ...
            try
            {
                Operator.Subtraction.Evaluate("a", 3D);
                                       ...
                                       "Cannot apply operator '-' to operands of type 'System.String' and 'System.Double'")
            {
            }
            ...
            try
            {
                Operator.Subtraction.Evaluate("1", new StringBuilder("X"));
                                       ...
                                       "Cannot apply operator '-' to operands of type 'System.String' and 'System.Text.StringBuilder'")
            {
            }
        ...
        public void TestMultiplyOperator()
        {
            ...
            Assert.AreEqual((new ArithmeticOperatorTester(1) * new ArithmeticOperatorTester(2)).Value,
                (Operator.Multiply.Evaluate(new ArithmeticOperatorTester(1), new ArithmeticOperatorTester(2)) as
                    ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass1(1) * new ArithmeticOperatorTester(2)).Value,
                (Operator.Multiply.Evaluate(new ArithmeticOperatorTesterSubClass1(1), new ArithmeticOperatorTester(2))
                    as ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass1(1) * new ArithmeticOperatorTesterSubClass2(2)).Value,
                (Operator.Multiply.Evaluate(new ArithmeticOperatorTesterSubClass1(1),
                    new ArithmeticOperatorTesterSubClass2(2)) as ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass2(1) * new ArithmeticOperatorTesterSubClass2(2)).Value,
                (Operator.Multiply.Evaluate(new ArithmeticOperatorTesterSubClass2(1),
                    new ArithmeticOperatorTesterSubClass2(2)) as ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass2(1) * new HaveValueClass1(2)).Value,
                (Operator.Multiply.Evaluate(new ArithmeticOperatorTesterSubClass2(1), new HaveValueClass1(2)) as
                    ArithmeticOperatorTester).Value);
            ...
            try
            {
                Operator.Multiply.Evaluate(january1, oneDay);
                                       ...
                                       "Cannot apply operator '*' to operands of type 'System.DateTime' and 'System.TimeSpan'")
            {
            }
            ...
            try
            {
                Operator.Multiply.Evaluate(twoDays, oneDay);
                                       ...
                                       "Cannot apply operator '*' to operands of type 'System.TimeSpan' and 'System.TimeSpan'")
            {
            }
        ...
        public void TestDivisionOperator()
        {
            ...
            Assert.AreEqual((new ArithmeticOperatorTester(1) / new ArithmeticOperatorTester(2)).Value,
                (Operator.Division.Evaluate(new ArithmeticOperatorTester(1), new ArithmeticOperatorTester(2)) as
                    ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass1(1) / new ArithmeticOperatorTester(2)).Value,
                (Operator.Division.Evaluate(new ArithmeticOperatorTesterSubClass1(1), new ArithmeticOperatorTester(2))
                    as ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass1(1) / new ArithmeticOperatorTesterSubClass2(2)).Value,
                (Operator.Division.Evaluate(new ArithmeticOperatorTesterSubClass1(1),
                    new ArithmeticOperatorTesterSubClass2(2)) as ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass2(1) / new ArithmeticOperatorTesterSubClass2(2)).Value,
                (Operator.Division.Evaluate(new ArithmeticOperatorTesterSubClass2(1),
                    new ArithmeticOperatorTesterSubClass2(2)) as ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass2(1) / new HaveValueClass1(2)).Value,
                (Operator.Division.Evaluate(new ArithmeticOperatorTesterSubClass2(1), new HaveValueClass1(2)) as
                    ArithmeticOperatorTester).Value);
        ...
        public void TestRemainderOperator()
        {
            ...
            Assert.AreEqual((new ArithmeticOperatorTester(1) % new ArithmeticOperatorTester(2)).Value,
                (Operator.Remainder.Evaluate(new ArithmeticOperatorTester(1), new ArithmeticOperatorTester(2)) as
                    ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass1(1) % new ArithmeticOperatorTester(2)).Value,
                (Operator.Remainder.Evaluate(new ArithmeticOperatorTesterSubClass1(1), new ArithmeticOperatorTester(2))
                    as ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass1(1) % new ArithmeticOperatorTesterSubClass2(2)).Value,
                (Operator.Remainder.Evaluate(new ArithmeticOperatorTesterSubClass1(1),
                    new ArithmeticOperatorTesterSubClass2(2)) as ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass2(1) % new ArithmeticOperatorTesterSubClass2(2)).Value,
                (Operator.Remainder.Evaluate(new ArithmeticOperatorTesterSubClass2(1),
                    new ArithmeticOperatorTesterSubClass2(2)) as ArithmeticOperatorTester).Value);
            Assert.AreEqual((new ArithmeticOperatorTesterSubClass2(1) % new HaveValueClass1(2)).Value,
                (Operator.Remainder.Evaluate(new ArithmeticOperatorTesterSubClass2(1), new HaveValueClass1(2)) as
                    ArithmeticOperatorTester).Value);
        ...
        public void TestAndOperator()
        {
            ...
            Assert.AreEqual((new HaveValueClass1(3) && new HaveValueClass1(2)) ? true : false,
                UnitTestCompatibilityExtensions.TernaryEvaluate(
                    Operator.And.Evaluate(new HaveValueClass1(3), new HaveValueClass1(2)), true, false));
            Assert.AreEqual((new HaveValueClass1(0) && new HaveValueClass1(2)) ? true : false,
                UnitTestCompatibilityExtensions.TernaryEvaluate(
                    Operator.And.Evaluate(new HaveValueClass1(0), new HaveValueClass1(2)), true, false));
            Assert.AreEqual((new HaveValueClass1(1) && new HaveValueClass1(0)) ? true : false,
                UnitTestCompatibilityExtensions.TernaryEvaluate(
                    Operator.And.Evaluate(new HaveValueClass1(1), new HaveValueClass1(0)), true, false));
            ...
            Assert.IsInstanceOfType(Operator.And.Evaluate(new HaveValueClass1(0), new HaveValueClass1(0)),
                typeof(HaveValueClass1));
            Assert.IsInstanceOfType(Operator.And.Evaluate(new HaveValueClass1(1), new HaveValueClass1(1)),
                typeof(HaveValueClass1));
            ...
            Assert.AreEqual((new ArithmeticOperatorTester(3) && new ArithmeticOperatorTester(2)) ? true : false,
                UnitTestCompatibilityExtensions.TernaryEvaluate(
                    Operator.And.Evaluate(new ArithmeticOperatorTester(3), new ArithmeticOperatorTester(2)), true,
                    false));
            Assert.AreEqual((new ArithmeticOperatorTester(0) && new ArithmeticOperatorTester(2)) ? true : false,
                UnitTestCompatibilityExtensions.TernaryEvaluate(
                    Operator.And.Evaluate(new ArithmeticOperatorTester(0), new ArithmeticOperatorTester(2)), true,
                    false));
            Assert.AreEqual((new ArithmeticOperatorTester(1) && new ArithmeticOperatorTester(0)) ? true : false,
                UnitTestCompatibilityExtensions.TernaryEvaluate(
                    Operator.And.Evaluate(new ArithmeticOperatorTester(1), new ArithmeticOperatorTester(0)), true,
                    false));
            Assert.AreEqual(new ArithmeticOperatorTester(1) && null,
                Operator.And.Evaluate(new ArithmeticOperatorTester(1), null));
            Assert.AreEqual(null && new ArithmeticOperatorTester(1),
                Operator.And.Evaluate(null, new ArithmeticOperatorTester(1)));
            Assert.IsInstanceOfType(
                Operator.And.Evaluate(new ArithmeticOperatorTester(0), new ArithmeticOperatorTester(0)),
                typeof(ArithmeticOperatorTester));
            Assert.IsInstanceOfType(
                Operator.And.Evaluate(new ArithmeticOperatorTester(1), new ArithmeticOperatorTester(1)),
                typeof(ArithmeticOperatorTester));
            Assert.IsInstanceOfType(Operator.And.Evaluate(new ArithmeticOperatorTester(0), null),
                typeof(ArithmeticOperatorTester));
            Assert.IsInstanceOfType(Operator.And.Evaluate(null, new ArithmeticOperatorTester(0)),
                typeof(ArithmeticOperatorTester));
        ...
        public void TestOrOperator()
        {
            ...
            Assert.AreEqual((new HaveValueClass1(3) || new HaveValueClass1(2)) ? true : false,
                UnitTestCompatibilityExtensions.TernaryEvaluate(
                    Operator.Or.Evaluate(new HaveValueClass1(3), new HaveValueClass1(2)), true, false));
            Assert.AreEqual((new HaveValueClass1(0) || new HaveValueClass1(2)) ? true : false,
                UnitTestCompatibilityExtensions.TernaryEvaluate(
                    Operator.Or.Evaluate(new HaveValueClass1(0), new HaveValueClass1(2)), true, false));
            Assert.AreEqual((new HaveValueClass1(1) || new HaveValueClass1(0)) ? true : false,
                UnitTestCompatibilityExtensions.TernaryEvaluate(
                    Operator.Or.Evaluate(new HaveValueClass1(1), new HaveValueClass1(0)), true, false));
            Assert.AreEqual((new HaveValueClass1(1) || null) ? true : false,
                UnitTestCompatibilityExtensions.TernaryEvaluate(Operator.Or.Evaluate(new HaveValueClass1(1), null),
                    true, false));
            Assert.AreEqual((null || new HaveValueClass1(1)) ? true : false,
                UnitTestCompatibilityExtensions.TernaryEvaluate(Operator.Or.Evaluate(null, new HaveValueClass1(1)),
                    true, false));
            Assert.IsInstanceOfType(Operator.Or.Evaluate(new HaveValueClass1(0), new HaveValueClass1(0)),
                typeof(HaveValueClass1));
            Assert.IsInstanceOfType(Operator.Or.Evaluate(new HaveValueClass1(1), new HaveValueClass1(1)),
                typeof(HaveValueClass1));
            ...
            Assert.AreEqual((new ArithmeticOperatorTester(3) || new ArithmeticOperatorTester(2)) ? true : false,
                UnitTestCompatibilityExtensions.TernaryEvaluate(
                    Operator.Or.Evaluate(new ArithmeticOperatorTester(3), new ArithmeticOperatorTester(2)), true,
                    false));
            Assert.AreEqual((new ArithmeticOperatorTester(0) || new ArithmeticOperatorTester(2)) ? true : false,
                UnitTestCompatibilityExtensions.TernaryEvaluate(
                    Operator.Or.Evaluate(new ArithmeticOperatorTester(0), new ArithmeticOperatorTester(2)), true,
                    false));
            Assert.AreEqual((new ArithmeticOperatorTester(1) || new ArithmeticOperatorTester(0)) ? true : false,
                UnitTestCompatibilityExtensions.TernaryEvaluate(
                    Operator.Or.Evaluate(new ArithmeticOperatorTester(1), new ArithmeticOperatorTester(0)), true,
                    false));
            Assert.AreEqual((new ArithmeticOperatorTester(1) || null) ? true : false,
                UnitTestCompatibilityExtensions.TernaryEvaluate(
                    Operator.Or.Evaluate(new ArithmeticOperatorTester(1), null), true, false));
            Assert.AreEqual((null || new ArithmeticOperatorTester(1)) ? true : false,
                UnitTestCompatibilityExtensions.TernaryEvaluate(
                    Operator.Or.Evaluate(null, new ArithmeticOperatorTester(1)), true, false));
            Assert.IsInstanceOfType(
                Operator.Or.Evaluate(new ArithmeticOperatorTester(0), new ArithmeticOperatorTester(0)),
                typeof(ArithmeticOperatorTester));
            Assert.IsInstanceOfType(
                Operator.Or.Evaluate(new ArithmeticOperatorTester(1), new ArithmeticOperatorTester(1)),
                typeof(ArithmeticOperatorTester));
            Assert.IsInstanceOfType(Operator.Or.Evaluate(new ArithmeticOperatorTester(1), null),
                typeof(ArithmeticOperatorTester));
            Assert.IsInstanceOfType(Operator.Or.Evaluate(null, new ArithmeticOperatorTester(1)),
                typeof(ArithmeticOperatorTester));
        ...
        public void TestNullCoalescingOperator()
        {
            ...
            Assert.AreEqual(4,
                (int?)Operator.NullCoalescing.EvaluateThrowException(4,
                    "If the first operator to the null coalescing operator is not null, the second should not be evaluated."));
        }
        ...
        public void TestLessThanOperator()
        {
            ...
            Assert.AreEqual(new ArithmeticOperatorTester(1) < new ArithmeticOperatorTester(2),
                Operator.LessThan.Evaluate(new ArithmeticOperatorTester(1), new ArithmeticOperatorTester(2)));
            Assert.AreEqual(new ArithmeticOperatorTesterSubClass1(1) < new ArithmeticOperatorTester(2),
                Operator.LessThan.Evaluate(new ArithmeticOperatorTesterSubClass1(1), new ArithmeticOperatorTester(2)));
            Assert.AreEqual(new ArithmeticOperatorTesterSubClass1(1) < new ArithmeticOperatorTesterSubClass2(2),
                Operator.LessThan.Evaluate(new ArithmeticOperatorTesterSubClass1(1),
                    new ArithmeticOperatorTesterSubClass2(2)));
            Assert.AreEqual(new ArithmeticOperatorTesterSubClass2(1) < new ArithmeticOperatorTesterSubClass2(2),
                Operator.LessThan.Evaluate(new ArithmeticOperatorTesterSubClass2(1),
                    new ArithmeticOperatorTesterSubClass2(2)));
            Assert.AreEqual(new ArithmeticOperatorTesterSubClass2(1) < new HaveValueClass1(2),
                Operator.LessThan.Evaluate(new ArithmeticOperatorTesterSubClass2(1), new HaveValueClass1(2)));
        ...
        public void TestGreaterThanOperator()
        {
            ...
            Assert.AreEqual(new ArithmeticOperatorTester(1) > new ArithmeticOperatorTester(2),
                Operator.GreaterThan.Evaluate(new ArithmeticOperatorTester(1), new ArithmeticOperatorTester(2)));
            Assert.AreEqual(new ArithmeticOperatorTesterSubClass1(1) > new ArithmeticOperatorTester(2),
                Operator.GreaterThan.Evaluate(new ArithmeticOperatorTesterSubClass1(1),
                    new ArithmeticOperatorTester(2)));
            Assert.AreEqual(new ArithmeticOperatorTesterSubClass1(1) > new ArithmeticOperatorTesterSubClass2(2),
                Operator.GreaterThan.Evaluate(new ArithmeticOperatorTesterSubClass1(1),
                    new ArithmeticOperatorTesterSubClass2(2)));
            Assert.AreEqual(new ArithmeticOperatorTesterSubClass2(1) > new ArithmeticOperatorTesterSubClass2(2),
                Operator.GreaterThan.Evaluate(new ArithmeticOperatorTesterSubClass2(1),
                    new ArithmeticOperatorTesterSubClass2(2)));
            Assert.AreEqual(new ArithmeticOperatorTesterSubClass2(1) > new HaveValueClass1(2),
                Operator.GreaterThan.Evaluate(new ArithmeticOperatorTesterSubClass2(1), new HaveValueClass1(2)));
            Assert.AreEqual(3.0 > new HaveValueClass1(2), Operator.GreaterThan.Evaluate(3, new HaveValueClass1(2)));

            try
            {
                //var thisWillNotCompile = new ArithmeticOperatorTester(1) > new ArithmeticOperatorTesterSubClass2(2);
                Operator.GreaterThan.Evaluate(new ArithmeticOperatorTester(1),
                    new ArithmeticOperatorTesterSubClass2(2));
                Assert.Fail(
                    $"Adding a {nameof(ArithmeticOperatorTester)} and a {nameof(ArithmeticOperatorTesterSubClass2)} should throw a {nameof(AmbiguousMatchException)}");
            }
        ...
        public void TestLessThanOrEqualOperator()
        {
            ...
            Assert.AreEqual(new ArithmeticOperatorTester(1) <= new ArithmeticOperatorTester(2),
                Operator.LessThanOrEqual.Evaluate(new ArithmeticOperatorTester(1), new ArithmeticOperatorTester(2)));
            Assert.AreEqual(new ArithmeticOperatorTesterSubClass1(1) <= new ArithmeticOperatorTester(2),
                Operator.LessThanOrEqual.Evaluate(new ArithmeticOperatorTesterSubClass1(1),
                    new ArithmeticOperatorTester(2)));
            Assert.AreEqual(new ArithmeticOperatorTesterSubClass1(1) <= new ArithmeticOperatorTesterSubClass2(2),
                Operator.LessThanOrEqual.Evaluate(new ArithmeticOperatorTesterSubClass1(1),
                    new ArithmeticOperatorTesterSubClass2(2)));
            Assert.AreEqual(new ArithmeticOperatorTesterSubClass2(1) <= new ArithmeticOperatorTesterSubClass2(2),
                Operator.LessThanOrEqual.Evaluate(new ArithmeticOperatorTesterSubClass2(1),
                    new ArithmeticOperatorTesterSubClass2(2)));
            Assert.AreEqual(new ArithmeticOperatorTesterSubClass2(1) <= new HaveValueClass1(2),
                Operator.LessThanOrEqual.Evaluate(new ArithmeticOperatorTesterSubClass2(1), new HaveValueClass1(2)));
            Assert.AreEqual(3.0 <= new HaveValueClass1(2),
                Operator.LessThanOrEqual.Evaluate(3, new HaveValueClass1(2)));

            try
            {
                //var thisWillNotCompile = new ArithmeticOperatorTester(1) <= new ArithmeticOperatorTesterSubClass2(2);
                Operator.LessThanOrEqual.Evaluate(new ArithmeticOperatorTester(1),
                    new ArithmeticOperatorTesterSubClass2(2));
                Assert.Fail(
                    $"Adding a {nameof(ArithmeticOperatorTester)} and a {nameof(ArithmeticOperatorTesterSubClass2)} should throw a {nameof(AmbiguousMatchException)}");
            }
        ...
        public void TestGreaterThanOrEqualOperator()
        {
            ...
            Assert.AreEqual(new ArithmeticOperatorTester(1) >= new ArithmeticOperatorTester(2),
                Operator.GreaterThanOrEqual.Evaluate(new ArithmeticOperatorTester(1), new ArithmeticOperatorTester(2)));
            Assert.AreEqual(new ArithmeticOperatorTesterSubClass1(1) >= new ArithmeticOperatorTester(2),
                Operator.GreaterThanOrEqual.Evaluate(new ArithmeticOperatorTesterSubClass1(1),
                    new ArithmeticOperatorTester(2)));
            Assert.AreEqual(new ArithmeticOperatorTesterSubClass1(1) >= new ArithmeticOperatorTesterSubClass2(2),
                Operator.GreaterThanOrEqual.Evaluate(new ArithmeticOperatorTesterSubClass1(1),
                    new ArithmeticOperatorTesterSubClass2(2)));
            Assert.AreEqual(new ArithmeticOperatorTesterSubClass2(1) >= new ArithmeticOperatorTesterSubClass2(2),
                Operator.GreaterThanOrEqual.Evaluate(new ArithmeticOperatorTesterSubClass2(1),
                    new ArithmeticOperatorTesterSubClass2(2)));
            Assert.AreEqual(new ArithmeticOperatorTesterSubClass2(1) >= new HaveValueClass1(2),
                Operator.GreaterThanOrEqual.Evaluate(new ArithmeticOperatorTesterSubClass2(1), new HaveValueClass1(2)));
            Assert.AreEqual(3.0 >= new HaveValueClass1(2),
                Operator.GreaterThanOrEqual.Evaluate(3, new HaveValueClass1(2)));

            try
            {
                //var thisWillNotCompile = new ArithmeticOperatorTester(1) >= new ArithmeticOperatorTesterSubClass2(2);
                Operator.GreaterThanOrEqual.Evaluate(new ArithmeticOperatorTester(1),
                    new ArithmeticOperatorTesterSubClass2(2));
                Assert.Fail(
                    $"Adding a {nameof(ArithmeticOperatorTester)} and a {nameof(ArithmeticOperatorTesterSubClass2)} should throw a {nameof(AmbiguousMatchException)}");
            }
        ...
        {
            AbstractSyntaxTree positiveShouldntBeEvaluated = new ThrowFunction()
            {
                FunctionName = "Throw",
                Arguments = new AbstractSyntaxTree[]
                    { new StringNode("If the condition is false, the positive should not be evaluated.") }
            };
            AbstractSyntaxTree negativeShouldntBeEvaluated = new ThrowFunction()
            {
                FunctionName = "Throw",
                Arguments = new AbstractSyntaxTree[]
                    { new StringNode("If the condition is true, the negative should not be evaluated.") }
            };

            Assert.AreEqual(true,
                TernaryOperator.Evaluate(new ValueNode(true), new ValueNode(true), negativeShouldntBeEvaluated,
                    new CultureInfo("de"), new object[0]));
            Assert.AreEqual(true,
                TernaryOperator.Evaluate(new ValueNode(false), positiveShouldntBeEvaluated, new ValueNode(true),
                    new CultureInfo("de"), new object[0]));
            ...
            Assert.AreEqual(true,
                TernaryOperator.Evaluate(new ValueNode(new HaveValueClass1(1)), new ValueNode(true),
                    negativeShouldntBeEvaluated, new CultureInfo("de"), new object[0]));
            Assert.AreEqual(false,
                TernaryOperator.Evaluate(new ValueNode(new HaveValueClass1(0)), positiveShouldntBeEvaluated,
                    new ValueNode(false), new CultureInfo("de"), new object[0]));
            Assert.AreEqual(true,
                TernaryOperator.Evaluate(new ValueNode(new ArithmeticOperatorTester(1)), new ValueNode(true),
                    negativeShouldntBeEvaluated, new CultureInfo("de"), new object[0]));
            Assert.AreEqual(false,
                TernaryOperator.Evaluate(new ValueNode(new ArithmeticOperatorTester(0)), positiveShouldntBeEvaluated,
                    new ValueNode(false), new CultureInfo("de"), new object[0]));
            ...
            try
            {
                ...
                Assert.Fail("The operator should fail if the condition is an integer");
                                                       ...
                                                       "Cannot apply operator '?:' when the first operand is of type 'System.Int32'")
            {
            }
        }
        ...
        public void TestGetImplicitOperatorPath()
        {
            ...
            var convertToBool =
                Operator.GetImplicitOperatorPath("op_Implicit", typeof(ArithmeticOperatorTester), typeof(bool));
            ...
            Assert.IsNull(Operator.GetImplicitOperatorPath("op_Implicit", typeof(ArithmeticOperatorTester),
                typeof(string)));
        }
        ...
        public void TestLogicalNotOperator()
        {
            ...
            Assert.AreEqual(!new ArithmeticOperatorTester(0),
                Operator.LogicalNot.Evaluate(new ArithmeticOperatorTester(0)));
            Assert.AreEqual(!new ArithmeticOperatorTester(1),
                Operator.LogicalNot.Evaluate(new ArithmeticOperatorTester(1)));
            Assert.AreEqual(!new ArithmeticOperatorTester(2),
                Operator.LogicalNot.Evaluate(new ArithmeticOperatorTester(2)));
        }
        ...
        public void TestUnaryNegationOperator()
        {
            ...
            Assert.AreEqual(-new ArithmeticOperatorTester(3),
                Operator.UnaryNegation.Evaluate(new ArithmeticOperatorTester(3)));
            Assert.AreEqual(-new ArithmeticOperatorTester(0),
                Operator.UnaryNegation.Evaluate(new ArithmeticOperatorTester(0)));
            Assert.AreEqual(-new ArithmeticOperatorTester(-3),
                Operator.UnaryNegation.Evaluate(new ArithmeticOperatorTester(-3)));
        }
    }
...
#pragma warning restore CS0464 // Comparing with null of type 'double?' always produces 'false'
    ...
    internal static class UnitTestCompatibilityExtensions
    {
        ...
        {
            return @operator.Evaluate(new ValueNode(x),
                new ThrowFunction()
                    { FunctionName = "Throw", Arguments = new AbstractSyntaxTree[] { new StringNode(errorMessage) } },
                CultureInfo.InvariantCulture, new[] { x });
        }

        internal static object TernaryEvaluate(object condition, object positive, object negative)
        {
            return TernaryOperator.Evaluate(new ValueNode(condition), new ValueNode(positive), new ValueNode(negative),
    ...
    internal class ArithmeticOperatorTester
    {
        ...
        public static ArithmeticOperatorTester operator &(ArithmeticOperatorTester x, ArithmeticOperatorTester y)
        {
            if (ReferenceEquals(null, x))
                ...
                return (x.Value != 0 && y.Value != 0)
                    ? new ArithmeticOperatorTester(1)
                    : new ArithmeticOperatorTester(0);
        }
        ...
        public static ArithmeticOperatorTester operator -(ArithmeticOperatorTester x) =>
            new ArithmeticOperatorTester(-x.Value);

        public static ArithmeticOperatorTester operator !(ArithmeticOperatorTester x) => ReferenceEquals(x, null)
            ? null
            : new ArithmeticOperatorTester(x.Value == 0 ? 1 : 0);
    ...
    internal class ArithmeticOperatorTesterSubClass1 : ArithmeticOperatorTester
    {
        ...
        public static ArithmeticOperatorTester operator +(ArithmeticOperatorTesterSubClass1 x,
            ArithmeticOperatorTester y)
        {
            return new ArithmeticOperatorTester(x.Value + y.Value);
        }

        public static ArithmeticOperatorTester operator +(ArithmeticOperatorTester x,
            ArithmeticOperatorTesterSubClass1 y)
        {
            return new ArithmeticOperatorTester(x.Value + y.Value);
        }

        public static ArithmeticOperatorTesterSubClass1 operator +(ArithmeticOperatorTesterSubClass1 x,
            ArithmeticOperatorTesterSubClass1 y)
        {
